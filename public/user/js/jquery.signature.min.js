...
!(function (a) {
    ...
    var b = {
        ...
        _mouseStop: function (a) {
            1 === this.curLine.length &&
                ((a.clientY += this.options.thickness), this._mouseDrag(a)),
                (this.lastPoint = null),
                (this.curLine = null),
                this._changed(a);
        },
        ...
        draw: function (a) {
            this.options.disabled ||
                (this.clear(!0),
                "string" == typeof a && 0 === a.indexOf("data:")
                    ? this._drawDataURL(a, this.options.scale)
                    : "string" == typeof a && a.indexOf("<svg") > -1
                    ? this._drawSVG(a, this.options.scale)
                    : this._drawJSON(a, this.options.scale),
                this._changed());
        },
