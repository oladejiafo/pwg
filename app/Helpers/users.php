...
class users
{
    ...
    {
        $applicant = Application::find($paidDetails->id);
        // if (strtoupper($paidDetails->third_payment_status) == 'PAID' && !empty($paidDetails->contract)) {
        //     $applicant->contractUrl = (isset($applicant->getMedia(Application::$media_collection_main_3rd_signature)[0])) ? $applicant->getMedia(Application::$media_collection_main_3rd_signature)[0]->getFullUrl() : null;
        //     if (!in_array($_SERVER['REMOTE_ADDR'], Constant::is_local)) {
        //         if (Storage::disk('s3')->exists($applicant->getMedia(Application::$media_collection_main_3rd_signature)[0]->getPath())) {
        //             // if(File::exists($applicant->getMedia(Application::$media_collection_main_3rd_signature)[0]->getPath())){
        //             return $applicant;
        //         }
        //     } else {
        //         if (File::exists($applicant->getMedia(Application::$media_collection_main_3rd_signature)[0]->getPath())) {
        ...
        //     $applicant->contractUrl = (isset($applicant->getMedia(Application::$media_collection_main_2nd_signature)[0])) ? $applicant->getMedia(Application::$media_collection_main_2nd_signature)[0]->getFullUrl() : null;
        //     if (!in_array($_SERVER['REMOTE_ADDR'], Constant::is_local)) {
        //         if (Storage::disk('s3')->exists($applicant->getMedia(Application::$media_collection_main_2nd_signature)[0]->getPath())) {
        //             // if(File::exists($applicant->getMedia(Application::$media_collection_main_2nd_signature)[0]->getPath())){
        //             return $applicant;
        //         }
        //     } else {
        //         if (File::exists($applicant->getMedia(Application::$media_collection_main_2nd_signature)[0]->getPath())) {
        ...
        //     $applicant->contractUrl = (isset($applicant->getMedia(Application::$media_collection_main_submission_signature)[0])) ? $applicant->getMedia(Application::$media_collection_main_submission_signature)[0]->getFullUrl() : null;
        //     if (!in_array($_SERVER['REMOTE_ADDR'], Constant::is_local)) {
        //         if (Storage::disk('s3')->exists($applicant->getMedia(Application::$media_collection_main_submission_signature)[0]->getPath())) {
        //             // if(File::exists($applicant->getMedia(Application::$media_collection_main_submission_signature)[0]->getPath())){
        //             return $applicant;
        //         }
        //     } else {
        //         if (File::exists($applicant->getMedia(Application::$media_collection_main_submission_signature)[0]->getPath())) {
        ...
        try{
            if (strtoupper($paidDetails->first_payment_status) == 'PAID' && !empty($paidDetails->contract)) {
                ...
                $applicant->contractUrl = (isset($applicant->getMedia(Application::$media_collection_main_1st_signature)[0])) ? $applicant->getMedia(Application::$media_collection_main_1st_signature)[0]->getFullUrl() : null;
