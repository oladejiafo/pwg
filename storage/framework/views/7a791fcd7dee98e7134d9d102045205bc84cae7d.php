                    ...
                    <div class="contract-section">
                        <div class="col-12 col-md-8 col-lg-12 offset-md-2 offset-lg-2 contractZoomIn">
                            ...
                            <div class="contractPdf">
                                <embed src="<?php echo e(asset('pdf/'.$newFileName)); ?>" type="application/pdf" />
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\shakun\Desktop\myGit\PWG\resources\views/user/contract.blade.php ENDPATH**/ ?>