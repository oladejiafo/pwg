        ...
        <div class="container">
          ...
          <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
            ...
            <source media="(min-width:769px)" srcset="<?php echo e(asset('images/logo.png')); ?>">
             ...
             <img class="logos" src="<?php echo e(asset('images/logo.png')); ?>" alt="logo">
             </picture>
...
<?php if(auth()->guard()->check()): ?>
   <div class="d-flex align-items-center justify-content-center jobbers">
     <a class="nav-link btn create-new-button"  aria-expanded="false" href="<?php echo e(url('myapplication')); ?>">
       <span style="display:inline-block"><img src="<?php echo e(asset('images/icon1.png')); ?>"></span><span class="title" style="padding-top:0px; display:inline-block">My Application </span>
     </a>
   </div>
 <?php else: ?>
   ...
   <div class="d-flex align-items-center justify-content-center jobber">
     ...
     <span><img src="<?php echo e(asset('images/icon2.png')); ?>"></span><span style="padding-top:5px">Affiliates</span>
   </a>
   </div>
 <?php endif; ?>
 <?php endif; ?>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="<?php echo e(asset('user/images/signin.svg')); ?>" style="width: 40px; height: 40px;" alt="">
...
<ul>
              <li class="nav-item">
                <a class="nav-link" href="<?php echo e(route('login')); ?>">
                  <div class="navbar-profile" style="font-family:'TT Norms Pro'; font-size: 18px; font-weight:500">
                    <img class="img-xs rounded-circlex" src="<?php echo e(asset('user/images/signin.svg')); ?>" style="width: 40px; height: 40px;" alt="">&nbsp; Sign In
                  </div>
                </a>
              </li>
</ul>
    ...
    <script src="../user/extra/assets/js/contact-form-script.min.js"></script>
       --><?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal\resources\views\user\headerSign.blade.php ENDPATH**/ ?>