                                    ...
                                    <div class="form-sec">
                                        <form method="POST" enctype="multipart/form-data" id="referrer_details">
                                            ...
                                            <div class="form-group row mt-4">
                                                ...
                                                <div class="form-floating col-sm-6 mt-3">
                                                    <input type="text" name="referrerPassport" id="floatingInput" class="form-control referrerPassport" placeholder="Referrer Passport Number" value="<?php echo e($applicant['referrer_passport_number_by_client']); ?>" autocomplete="off" />
                                ...
                                <div class="row">
                                    <div class="col-2">
                                        <div class="image my-auto">
                                            <img src="<?php echo e(asset('images/Icons_applicant_details.svg')); ?>" alt="PWG Group" width="70%" height="100px">
                                        </div>
                                    </div>
                                    <div class="col-1">
                                        <div class="vl"></div>
                                    ...
                                    <div class="col-2 mx-auto my-auto">
                                        <div class="down-arrow">
                                            <img src="<?php echo e(asset('images/down_arrow.png')); ?>" alt="PWG Group" height="auto" width="25%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="applicant-detail-sec">
                            <div class="heading" data-bs-toggle="collapse" data-bs-target="#collapseHome" aria-expanded="true" aria-controls="collapseHome">
                                <div class="row">
                                    <div class="col-2 my-auto">
                                        <div class="image">
                                            <img src="<?php echo e(asset('images/Icons_home_country_details.svg')); ?>" alt="PWG Group" width="70%" height="100px">
                                        </div>
                                    </div>
                                    <div class="col-1">
                                        <div class="vl"></div>
                        ...
                        <div class="applicant-detail-sec">
                            <div class="heading" data-bs-toggle="collapse" data-bs-target="#collapseCurrent" aria-expanded="true" aria-controls="collapseCurrent">
                                <div class="row">
                                    <div class="col-2 my-auto">
                                        <div class="image">
                                            <img src="<?php echo e(asset('images/Icons_current_residency_and_work_details.svg')); ?>" alt="PWG Group" width="70%" height="100px">
                                        </div>
                                    </div>
                                    <div class="col-1">
                                        <div class="vl"></div>
                        ...
                        <div class="applicant-detail-sec">
                            <div class="heading"  data-bs-toggle="collapse" data-bs-target="#collapseSchengen" aria-expanded="true" aria-controls="collapseSchengen">
                                <div class="row">
                                    <div class="col-2 my-auto">
                                        <div class="image">
                                            <img src="<?php echo e(asset('images/Icons_schengen_details.svg')); ?>" alt="PWG Group" width="70%" height="100px">
                                        </div>
                                    </div>
                                    <div class="col-1">
                                        <div class="vl"></div>
                        ...
                        <div class="applicant-detail-sec" style="margin-bottom: 70px">
                            <div class="heading" data-bs-toggle="collapse" data-bs-target="#collapseExperience" aria-expanded="true" aria-controls="collapseExperience">
                                <div class="row">
                                    <div class="col-2 my-auto">
                                        <div class="image">
                                            <img src="<?php echo e(asset('images/Icons_experience_details.svg')); ?>" alt="PWG Group" width="70%" height="100px">
                                        </div>
                                    </div>
                                    <div class="col-1">
                                        <div class="vl"></div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-1 mx-auto my-auto">
                                                            <div class="down-arrow" data-bs-toggle="collapse" :data-bs-target="'#collapseExperience'+data.id" aria-expanded="false" :aria-controls="'collapseExperience'+data.id">
                                                                <img src="<?php echo e(asset('images/down_arrow.png')); ?>" alt="PWG Group" height="auto" class="exp-image">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<script>
    ...
    $(document).ready(function()
    {
        ...
        $('#current_residency').submit(function(e){
            ...
            console.log(phoneCurrentInput.intlTelInputUtils);
        ...
        $("#referrer_details").submit(function(e){
            ...
            if($('.referrerName').val() || $('.referrerName').val() ){
                ...
                $.ajax({
                type: 'POST',
                url: "<?php echo e(url('store/referrer/details')); ?>",
                data: formData,
                processData: false,
                contentType: false,
                success: function (data) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal - optimization\resources\views/user/application-review.blade.php ENDPATH**/ ?>