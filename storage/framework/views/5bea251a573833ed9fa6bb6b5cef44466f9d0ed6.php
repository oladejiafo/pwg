        ...
        <tbody>
            ...
            <td style="box-sizing:border-box;font-family:Yantramanav,sans-serif" align="center">
                ...
                <tbody>
                    <tr>
                        <td>
                            <div style="box-sizing:border-box;font-family:Yantramanav,sans-serif;margin-bottom:30px">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div style="box-sizing:border-box;font-family:Yantramanav,sans-serif;height: 80%;width: 11%; margin: 30px auto 10px auto;">
                                        <img src="<?php echo e(asset('images/logoo.png')); ?>" alt="" width="100%" height="100%">
                                    </div>
                                    <p style="text-align: center">We are for people</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="box-sizing:border-box;font-family:Yantramanav,sans-serif;max-width:100vw;padding:0 32px 32px 32px">
                                    <div style="box-sizing:border-box;font-family:Yantramanav,sans-serif;width:400px;height:250px;display:block;margin:30px auto">
                                        <img src="<?php echo e(asset('images/reminder.png')); ?>" alt="" width="100%" height="100%">
                                    </div>
                                    <h1 style="box-sizing:border-box;font-family:Yantramanav,sans-serif;color:#3d4852;font-size:24px;font-weight:bold;margin-top:0;text-align:left">Payment Reminder</h1>
                                    ...
                                    <p style="box-sizing:border-box;font-family:Yantramanav,sans-serif;font-size:15px;line-height:1.5em;margin-top:0;text-align:left">Thank you for choosing and trusting us with your journey to <?php echo e(ucFirst($data['product'])); ?>.</p>
                                    <p style="box-sizing:border-box;font-family:Yantramanav,sans-serif;font-size:15px;line-height:1.5em;margin-top:0;text-align:left">Your visa application cannot be processed until the pending balance has been offset.</p>
                                    <p style="box-sizing:border-box;font-family:Yantramanav,sans-serif;font-size:15px;line-height:1.5em;margin-top:0;text-align:left">Kindly make the necessary payment to avoid any delays in the processing of your application. Thank you for your cooperation</p>
                                                            ...
                                                            <table role="presentation" style="box-sizing:border-box;font-family:Yantramanav,sans-serif" cellspacing="0" cellpadding="0" border="0">
                                                                <tbody><tr>
                                                                    <td style="box-sizing:border-box;font-family:Yantramanav,sans-serif">
                                                                        <a href="<?php echo e(env('APP_URL')); ?>/payment_form/<?php echo e($data['productId']); ?>" class="m_6264836849513322656button" rel="noopener" style="font-size: 20px;font-weight:500;box-sizing:border-box;float:left;border-radius:4px;color:#fff;display:inline-block;overflow:hidden;text-decoration:none;padding:12px;width:200px;text-align:center;background-color:#2ead0c!important;border:1px solid #c4c6cd" target="_blank" >Click to Pay Now</a>
                                                                    </td>
                                                                </tr>
                                                            </tbody></table>
                                                        </td>
...
</html><?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal\resources\views/emails/Reminder-template.blade.php ENDPATH**/ ?>