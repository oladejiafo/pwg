...
} elseif ($_instance->childHasBeenRendered('sOizvn8')) {
    $componentId = $_instance->getRenderedChildComponentId('sOizvn8');
    $componentTag = $_instance->getRenderedChildComponentTagName('sOizvn8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sOizvn8');
} else {
    $response = \Livewire\Livewire::mount('profile.update-profile-information-form');
    $html = $response->html();
    $_instance->logRenderedChild('sOizvn8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
