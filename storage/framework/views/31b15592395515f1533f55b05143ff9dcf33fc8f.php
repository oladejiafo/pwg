...
} elseif ($_instance->childHasBeenRendered('Qh9RPrY')) {
    $componentId = $_instance->getRenderedChildComponentId('Qh9RPrY');
    $componentTag = $_instance->getRenderedChildComponentTagName('Qh9RPrY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Qh9RPrY');
} else {
    $response = \Livewire\Livewire::mount('profile.update-profile-information-form');
    $html = $response->html();
    $_instance->logRenderedChild('Qh9RPrY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
