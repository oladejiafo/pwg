...
} elseif ($_instance->childHasBeenRendered('Y2E3uwm')) {
    $componentId = $_instance->getRenderedChildComponentId('Y2E3uwm');
    $componentTag = $_instance->getRenderedChildComponentTagName('Y2E3uwm');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Y2E3uwm');
} else {
    $response = \Livewire\Livewire::mount('profile.update-profile-information-form');
    $html = $response->html();
    $_instance->logRenderedChild('Y2E3uwm', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
