...
} elseif ($_instance->childHasBeenRendered('jZMddwC')) {
    $componentId = $_instance->getRenderedChildComponentId('jZMddwC');
    $componentTag = $_instance->getRenderedChildComponentTagName('jZMddwC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('jZMddwC');
} else {
    $response = \Livewire\Livewire::mount('profile.update-profile-information-form');
    $html = $response->html();
    $_instance->logRenderedChild('jZMddwC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
