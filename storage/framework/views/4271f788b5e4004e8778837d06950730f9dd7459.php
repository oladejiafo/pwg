...
<?php if($paid->first_payment_paid > 0 && $paid->first_payment_remaining > 0 && strtoupper($paid->first_payment_status) == 'PARTIALLY_PAID'): ?>
    <?php
        $type = 'Pay';
        $color = '#800000';
    ...
    <?php if(isset($msg) && strlen($msg) > 2): ?>
        <div class="row pay-info" style="background-color: <?php echo e($color); ?>; float:left;border-radius:5px">
            ...
            <?php if(isset($type) && $type == 'Pay'): ?>
                ...
                <?php if($paid->first_payment_paid > 0 && $paid->first_payment_status != "PAID" && $paid->is_first_payment_partially_paid == 0): ?>
