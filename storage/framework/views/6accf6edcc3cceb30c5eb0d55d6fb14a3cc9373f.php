...
$message = $__bag->first($__errorArgs[0]); ?> <span class="error" style="text-align:left; font-size:16px"><?php echo e($message); ?></span> <?php unset($message);
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dejia\OneDrive\Desktop\mygit\pwg_eportal\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>