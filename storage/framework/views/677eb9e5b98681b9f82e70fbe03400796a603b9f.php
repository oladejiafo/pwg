                                        ...
                                        <form method="POST" id="applicant_details">
                                            ...
                                            <div class="form-group row mt-4">
                                                <div class="col-sm-4 mt-3 form-floating">
                                                    <input type="tel" id="first_name" name="first_name" class="form-control" placeholder="First Name*" value="<?php echo e($client['name']); ?>" autocomplete="off" required/>
                                            ...
                                            <div class="form-group row mt-4">
                                                ...
                                                <div class="col-sm-6 mt-3 form-floating">
                                                    ...
                                                    <input type="tel" style="margin-left: -10px !important;" name="phone_number" class="form-control" id="phone" placeholder="Phone Number*" value="<?php echo e($client['phone_number']); ?>" autocomplete="off"  required/>
                                    ...
                                    <div class="form-sec">
                                        <form method="POST" enctype="multipart/form-data" id="current_residency">
                                            ...
                                            <div class="form-group row mt-4">
                                                ...
                                                <div class="col-sm-6 mt-3 form-floating">
                                                    <input type="tel" style="margin-left: -10px !important;" class="form-control" id="current_residance_mobile" name='current_residance_mobile' value="<?php echo e($client['residence_mobile_number']); ?>" placeholder="Current Residence Mobile Number" autocomplete="off">
                                        ...
                                        <form method="POST" enctype="multipart/form-data" id="dependent_applicant_details">
                                            ...
                                            <div class="form-group row mt-4">
                                                ...
                                                <div class="col-sm-6 mt-3 form-floating">
                                                    ...
                                                    <input type="tel" name="dependent_phone_number" class="form-control dependent_phone_number" id="dependent_phone" placeholder="Phone Number*" value="<?php echo e($dependent['phone_number']); ?>" autocomplete="off"  />
                                        ...
                                        <form method="POST" enctype="multipart/form-data" id="dependent_current_residency">
                                            ...
                                            <div class="form-group row mt-4">
                                                ...
                                                <div class="col-sm-6 mt-3 form-floating">
                                                    ...
                                                    <input type="tel" class="form-control" id="dependent_current_residance_mobile" name='dependent_current_residance_mobile' value="<?php echo e($dependent['residence_mobile_number']); ?>" placeholder="Current Residence Mobile Number" autocomplete="off">
                                            ...
                                            <div class="form-group row mt-4">
                                                ...
                                                <div class="form-floating col-sm-6 mt-3">
                                                    ...
                                                    <?php if($dependent['visaCopyUrl'] != null): ?>
                                        ...
                                        <form method="POST" enctype="multipart/form-data" id="dependent_schengen_details">
                                            ...
                                            <div class="form-group row mt-4 dependent_schengen_visa">
                                                <div class="form-floating col-sm-12 mt-3" id="dependent_schengen_visa">
                                                    ...
                                                    <?php if($dependent['schengenVisaUrl'] != null): ?>
                                ...
                                <div class="applicant-detail-sec" <?php if($key+1 ==  $client['children_count']): ?> style="margin-bottom:70px" <?php endif; ?>>
                                    <div class="heading">
                                        <div class="row">
                                            ...
                                            <div class="col-2 mx-auto my-auto">
                                                <div class="down-arrow" data-bs-toggle="collapse" data-bs-target="#collapsechild<?php echo e($key+1); ?>" aria-expanded="true" aria-controls="collapsechild<?php echo e($key+1); ?>">
                                                    <img src="<?php echo e(asset('images/down_arrow.png')); ?>" height="auto" width="25%">
                                                </div>
                                            </div>
                                        </div>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div id="passportModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <embed src="<?php echo e($client['passporUrl']); ?>#toolbar=0" frameBorder="0" borders="false" width="100%" height="400px" style="border: none" />
                    </div>
                    <div class="modal-footer">
        ...
        <div id="cvModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <embed src="<?php echo e($client['resumeUrl']); ?>#toolbar=0" frameBorder="0" borders="false" width="100%" height="400px" style="border: none" />
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                    </div>
        ...
        <div id="residenceCopyModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <embed src="<?php echo e($client['residenceUrl']); ?>#toolbar=0" frameBorder="0" borders="false" width="100%" height="400px" style="border: none" />    
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                    </div>
        ...
        <div id="visaCopyModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <embed src="<?php echo e($client['visaCopyUrl']); ?>#toolbar=0" frameBorder="0" borders="false" width="100%" height="400px" style="border: none" />
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                    </div>
        ...
        <div id="schengenVisatModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <embed src="<?php echo e($client['schengenVisaUrl']); ?>#toolbar=0" frameBorder="0" borders="false" width="100%" height="400px" style="border: none" />
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                    </div>
        ...
        <?php if($dependent): ?>
            <div id="resumeModal" class="modal fade" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            <embed src="<?php echo e($dependent['resumeUrl']); ?>#toolbar=0" frameBorder="0" borders="false" width="100%" height="400px" style="border: none" />
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                        </div>
            ...
            <div id="dependentPassword" class="modal fade" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            <embed src="<?php echo e($dependent['passportUrl']); ?>#toolbar=0" frameBorder="0" borders="false" width="100%" height="400px" style="border: none" />
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                        </div>
            ...
            <div id="dependentResidence" class="modal fade" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            <embed src="<?php echo e($dependent['residenceUrl']); ?>#toolbar=0" frameBorder="0" borders="false" width="100%" height="400px" style="border: none" />
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                        </div>
            ...
            <div id="dependentVisa" class="modal fade" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            <embed src="<?php echo e($dependent['visaCopyUrl']); ?>#toolbar=0" frameBorder="0" borders="false" width="100%" height="400px" style="border: none" />
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                        </div>
            ...
            <div id="dependentSchengenVisatModal" class="modal fade" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            <embed src="<?php echo e($dependent['schengenVisaUrl']); ?>#toolbar=0" frameBorder="0" borders="false" width="100%" height="400px" style="border: none" />
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal\resources\views\user\application-review.blade.php ENDPATH**/ ?>