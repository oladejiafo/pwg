                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="toolbox-left-sec">
                                            <img src="<?php echo e(asset('images/affiliate/'.$present->image_url)); ?>"  width="100%" height="100%">
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6">
            ...
            $.ajax({
                ...
                success:function(response){  
                    ...
                    $.each(response, function( index, value ) {
                        $('.presentation').append('<div class="toolbox-sec"><div class="row"><div class="col-xs-12 col-sm-12 col-md-12 col-lg-6"><div class="toolbox-left-sec"><img src="<?php echo e(asset('images/affiliate')); ?>/'+value.image_url+'" width="100%" height="100%"></div></div><div class="col-xs-12 col-sm-12 col-md-12 col-lg-6"><div class="toolbox-right-sec"><h1>'+value.title+'</h1><p class="toolbox-right-sub-head">'+value.sub_title+'</p><p class="toolbox-right-desc">'+(value.details).substring(0,500)+'</p><input type="button" class="btn startCopy" value="Copy Link" onclick="Copy('+value.link_ur+');" /></div></div></div></div>');
                        lastid = value.id;
                    });
                }
            });
