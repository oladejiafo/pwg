  ...
  <div class="container">
      <div class="form-sec1">
        ...
        <div class="tab-sec">
            ...
            <a href="<?php echo e(route('flogin')); ?>" class="signupBtn">Login</a>
        </div>
        <div class="form-sec">
          <form method="POST" action="<?php echo e(route('flogin')); ?>">
            <?php echo csrf_field(); ?>
            <div class="mb-3">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal\resources\views\auth\flogin.blade.php ENDPATH**/ ?>