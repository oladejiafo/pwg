...
<?php $__env->startSection('content'); ?>
  <div class="container">
      <div class="form-sec1">
        ...
        <div class="tab-sec">
            <a href="<?php echo e(route('affiliate.register')); ?>">Signup</a>
            <a href="<?php echo e(route('affiliate.login')); ?>" class="signupBtn">Login</a>
        </div>
        <div class="form-sec">
          <form method="POST" action="<?php echo e(route('affiliate.affiliate-login')); ?>">
            <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dejia\OneDrive\Desktop\mygit\pwg_eportal\resources\views/affiliate/auth/login.blade.php ENDPATH**/ ?>