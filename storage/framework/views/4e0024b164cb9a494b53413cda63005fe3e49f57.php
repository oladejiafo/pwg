...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('content', null, ['class' => 'flex items-center']); ?>    

        <div class="mt-3 max-w-xl text-sm text-gray-600 flex-center" style="width:100%; margin: 0 auto;margin-bottom:20px">
        <h3 class="text-lg font-medium text-gray-900" >
        <?php echo e(__('Add additional security to your account using two factor authentication.')); ?> <br><br>
            <?php if($this->enabled): ?>
            ...
            <div class="mt-5" style="width:70%; margin: 0 auto;margin-bottom:20px">
            <?php if(! $this->enabled): ?>
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal\resources\views/profile/two-factor-authentication-form.blade.php ENDPATH**/ ?>