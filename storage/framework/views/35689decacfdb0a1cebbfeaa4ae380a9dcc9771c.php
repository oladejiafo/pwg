...
<?php if($paid->work_permit_status == 'WORK_PERMIT_RECEIVED' && $workpermitFile['FileExist']): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php if($paid->first_payment_remaining > 0 && strtoupper($paid->first_payment_status) == 'PARTIALLY_PAID' ): ?>
    <?php
        $type = 'Pay';
        $color = '#800000';
                            ...
                            <?php elseif(
                                ...
                                <?php elseif(
                                    ...
                                    <div class="row">
                                        ...
                                        <div align="center" <?php if($pays->third_payment_sub_total > 0): ?> class="col-lg-3 col-md-12 col-sm-12 img-fluid cellContainerx" <?php else: ?> class="col-lg-4 col-md-12 col-sm-12 img-fluid cellContainerx" <?php endif; ?>>
                                            <div class="upper">
                                                <span class="paid-item positionAnchor" href="#">
                                        ...
                                        <?php if($pays->third_payment_sub_total > 0): ?>
                                            <!-- 3rd Payment Column  -->
    ...
    <?php if(isset($prod->id)): ?>
        ...
        <div class="card d-flex aligns-items-center justify-content-center text-center wiggy pay-full"
            ...
            <p style="margin-top: 5px;">
                ...
                <?php elseif(($paid->first_payment_status != "PAID" && $paid->first_payment_verified_by_cfo == 0 && $paid->first_payment_txn_mode == 'TRANSFER')): ?>
                    <button class="btn btn-secondary toastrDefaultError"
                        style="border-width:thin; width:250px; height:60px; font-size:32px; font-weight:bold" 
...
<?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal - optimization\resources\views/user/paid.blade.php ENDPATH**/ ?>