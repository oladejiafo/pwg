...
->where('client_id', '=', Session::has('loginId'))
->orderBy('id', 'desc')
->orderBy('status', 'desc')
->limit(5)
->get();
...
</script><?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal\resources\views/affiliate/notifications.blade.php ENDPATH**/ ?>