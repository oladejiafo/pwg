<div class="row">
    <div class="collapse" id="collapseSpouseExperience" data-applicantId="<?php echo e($applicant['id']); ?>" data-dependentId="<?php echo e($dependent); ?>">
        <div class="form-sec">
                        ...
                        <div class="detail-sec">
                            ...
                            <div class="form-group row mt-4" style="margin-bottom: 20px">
                                <div class="row">
                                    ...
                                    <button type="button" v-else  class="btn btn-primary submitBtn addExperience" data-dependentId="<?php echo e($dependent); ?>" v-on:click="addExperience(null,null,data.job_category_three_id,data.id,data.name,'dependent')" style="line-height: 22px">Add Experience</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="detail-sec">
                                                    ...
                                                    <div class="form-group row mt-4" style="margin-bottom: 20px">
                                                        <div class="row">
                                                            ...
                                                            <button type="button" v-else class="btn btn-primary submitBtn addExperience" data-dependentId="<?php echo e($dependent); ?>"  v-on:click="addExperience(jobCategoryOne.id,jobCategoryTwo.id,jobCategoryThree.id,jobCategoryFour.id,jobCategoryFour.name, 'dependent')" style="line-height: 22px">Add Experience</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
</div><?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal - optimization\resources\views/user/dependent-experience.blade.php ENDPATH**/ ?>