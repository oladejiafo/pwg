...
} elseif ($_instance->childHasBeenRendered('CNYQOGB')) {
    $componentId = $_instance->getRenderedChildComponentId('CNYQOGB');
    $componentTag = $_instance->getRenderedChildComponentTagName('CNYQOGB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('CNYQOGB');
} else {
    $response = \Livewire\Livewire::mount('profile.update-profile-information-form');
    $html = $response->html();
    $_instance->logRenderedChild('CNYQOGB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
