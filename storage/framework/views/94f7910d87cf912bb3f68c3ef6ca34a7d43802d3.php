...
} elseif ($_instance->childHasBeenRendered('TX6bObP')) {
    $componentId = $_instance->getRenderedChildComponentId('TX6bObP');
    $componentTag = $_instance->getRenderedChildComponentTagName('TX6bObP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TX6bObP');
} else {
    $response = \Livewire\Livewire::mount('profile.update-profile-information-form');
    $html = $response->html();
    $_instance->logRenderedChild('TX6bObP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
