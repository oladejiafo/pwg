...
} elseif ($_instance->childHasBeenRendered('5vy8KmC')) {
    $componentId = $_instance->getRenderedChildComponentId('5vy8KmC');
    $componentTag = $_instance->getRenderedChildComponentTagName('5vy8KmC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5vy8KmC');
} else {
    $response = \Livewire\Livewire::mount('profile.update-profile-information-form');
    $html = $response->html();
    $_instance->logRenderedChild('5vy8KmC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
