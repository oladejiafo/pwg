...
} elseif ($_instance->childHasBeenRendered('3yAawUe')) {
    $componentId = $_instance->getRenderedChildComponentId('3yAawUe');
    $componentTag = $_instance->getRenderedChildComponentTagName('3yAawUe');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3yAawUe');
} else {
    $response = \Livewire\Livewire::mount('profile.update-profile-information-form');
    $html = $response->html();
    $_instance->logRenderedChild('3yAawUe', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
