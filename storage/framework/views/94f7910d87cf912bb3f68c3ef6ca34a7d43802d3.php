...
} elseif ($_instance->childHasBeenRendered('dr0QRJP')) {
    $componentId = $_instance->getRenderedChildComponentId('dr0QRJP');
    $componentTag = $_instance->getRenderedChildComponentTagName('dr0QRJP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dr0QRJP');
} else {
    $response = \Livewire\Livewire::mount('profile.update-profile-information-form');
    $html = $response->html();
    $_instance->logRenderedChild('dr0QRJP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
