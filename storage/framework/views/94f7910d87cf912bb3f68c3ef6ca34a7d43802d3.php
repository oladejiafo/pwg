...
} elseif ($_instance->childHasBeenRendered('N2Janba')) {
    $componentId = $_instance->getRenderedChildComponentId('N2Janba');
    $componentTag = $_instance->getRenderedChildComponentTagName('N2Janba');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('N2Janba');
} else {
    $response = \Livewire\Livewire::mount('profile.update-profile-information-form');
    $html = $response->html();
    $_instance->logRenderedChild('N2Janba', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
