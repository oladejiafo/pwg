...
<script>
    var timer = new Date("<?php echo e($timer); ?>".replace(/-/g, '/'));
    var countDownDate = new Date("<?php echo e($timer); ?>".replace(/-/g, '/')).getTime();
...
<?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal - optimization\resources\views/user/footer.blade.php ENDPATH**/ ?>