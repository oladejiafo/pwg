...
unset($__errorArgs, $__bag); ?>
          ...
          <div class="mb-3">
            ...
            <div class="inputs">
              <input type="text" style="paddingx: 10px;" placeholder="Who reffered you? Type the code here, if any" class="form-control refferer" id="refferer" name="refferer" aria-describedby="emailHelp" autocomplete="off" value="<?php echo e(old('refferer')); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal\resources\views\affiliate\auth\register.blade.php ENDPATH**/ ?>