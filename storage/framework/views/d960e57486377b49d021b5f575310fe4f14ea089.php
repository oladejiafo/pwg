        ...
        <div class="container">
          <!-- Brand and toggle get grouped for better mobile display -->
            <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
              <picture>
                <source media="(min-width:1025px)" srcset="<?php echo e(asset('images/logo.png')); ?>">
             ...
             <?php if(auth()->guard()->check()): ?>
              ...
              <li class="nav-item">
                <a target="_blank" class="nav-link" href="https://wa.link/16s7s9" title="Click Here To Chat on WhatsAPP">
                  ...
                  <img src="<?php echo e(asset('user/images/chat_new.svg')); ?>" width="35px" height="35px" alt="PWG icon3"> <span class="titled"> Chat</span>
              ...
              <li class="nav-item dropdown border-left">
                <a class="nav-link"  id="notificationDropdown" href="#" data-toggle="dropdown">
                  ...
                  <img src="<?php echo e(asset('user/images/notification_new.svg')); ?>" width="35px" height="35px" alt="icon3"> <span class="titled"> Notifications</span>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="<?php echo e(asset('user/images/profile_new.svg')); ?>" style="width: 35px; height: 35px;" alt="PWG "> <span class="titled"> My Profile</span>
