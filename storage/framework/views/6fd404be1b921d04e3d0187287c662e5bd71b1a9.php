          ...
          <div class="card-body">
            <table width="100%">
              <tr style="color: #9d9e9f;background-color: #fff; border-block: 1px solid #cccccc;">
                <th style="padding:5px; font-size:18px;">Earned From</th>
                <th style="padding:5px; font-size:18px;text-align:right">Earned Commission</th>
              ...
              <?php $__currentLoopData = $affiliates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $affiliate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr style="color: #9d9e9f;background-color: #fff;">
                  ...
                  <td style="padding:5px; font-size:15px;text-align:center"><?php echo e(date('Y-m-d', strtotime($affiliate->created_at))); ?></td>
                  <td style="padding:5px; font-size:15px;text-align:center"><?php echo e($client->first_payment_status); ?></td>
                </tr>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              <tr style="color:#9d9e9f;background-color: #fff; padding-block:10px; border-block: 1px solid #cccccc;font-weight:bold">
                <td style="padding:5px; font-size:17px;">Total:</td>
