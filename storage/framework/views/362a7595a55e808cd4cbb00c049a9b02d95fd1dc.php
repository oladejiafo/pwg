        ...
        <div class="col-12">
            <div align="center" class="package">
                ...
                <div class="row" style="margin-left:auto; margin-right:auto; text-align:center;justify-content: center; display: flex;">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4" style="display:inline-block;padding-bottom:25px;">
                        <img src="<?php echo e(asset('user/images/maltapackage.png')); ?>" width="100%" alt="PWG Group">
                        <div class="package-type blue-collar" data-bs-toggle="modalXX" data-bs-target="#individualModalXX">
                            <div class="content">
                                <div>
                                    <div class="row price">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4" style="display:inline-block;padding-bottom:25px;">
                        <img src="<?php echo e(asset('user/images/canadaPackage.png')); ?>" width="100%" alt="PWG Group">
                        <div class="package-type blue-collar" data-bs-toggle="modalXX" data-bs-target="#individualModalXX">
                            <div class="content">
                                <div>
                                    <div class="row price">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4" style="display:inline-block;padding-bottom:25px;">
                        <img src="<?php echo e(asset('user/images/germanypackage.png')); ?>" width="100%" alt="PWG Group" style="height: 272px;">
                        <div class="package-type blue-collar" data-bs-toggle="modalXX" data-bs-target="#individualModalXX">
                            <div class="content">
                                <div>
                                    <div class="row price">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dejia\OneDrive\Desktop\mygit\pwg_eportal\resources\views/user/home.blade.php ENDPATH**/ ?>