...
<link type="text/css" href="<?php echo e(asset('user/css/jquery.signature.css')); ?>" rel="stylesheet">
...
<script type="text/javascript" src="<?php echo e(asset('user/js/jquery.signature.min.js')); ?>"></script>
<!-- <script type="text/javascript" src="<?php echo e(asset('user/js/jquery.signature.js')); ?>"></script> -->
    <div class="login">
                    ...
                    <div class="append">
                        <div class="append-title">
                            ...
                            <div class="col-8 offset-2">
                                <form action="<?php echo e(url('upload_signature')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal\resources\views\user\signatureX2.blade.php ENDPATH**/ ?>