<div class="tab-pane active" id="dependant">
            ...
            <div class="row">
                <div class="col-2">
                    <div class="image my-auto">
                        <img src="<?php echo e(asset('images/Icons_applicant_details.svg')); ?>" width="100%" height="100%">
                    </div>
                </div>
                <div class="col-1">
                    <div class="vl"></div>
                ...
                <div class="form-sec">
                    ...
                    <form method="POST" enctype="multipart/form-data" id="dependent_applicant_details">
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="form-floating col-sm-4 mt-3">
                                <input type="text" name="dependent_middle_name" class="form-control" id="dependent_middle_name" placeholder="Middle Name" value="<?php echo e(old('dependent_middle_name')); ?>"  autocomplete="off"/>
                        ...
                        <div class="form-group row mt-4">
                            <div class="form-floating col-sm-12 mt-3">
                                <input type="text" class="form-control dependent_resume" placeholder="Upload your cv (PDF only)*" name="dependent_resume" value="<?php echo e(old('cv')); ?>" readonly required>
                                <div class="input-group-btn">
                                    <span class="fileUpload btn">
                                        <span class="upl" id="upload">Choose File</span>
                                        <input type="file" class="upload up dependent_resume dependentUpload" id="up"  name="dependent_resume" accept=".pdf, .doc" />
                                      </span><!-- btn-orange -->
                                </div><!-- btn -->
                        ...
                        <div class="form-group row mt-4">
                            <div class="form-floating col-sm-4 mt-3 dob">
                                <input type="text" name="dependent_dob" class="form-control dependent_datepicker" id="dependent_datepicker" placeholder="Date of Birth*" value="<?php echo e(old('dependent_dob')); ?>" id="dependent_datepicker" autocomplete="off"  readonly="readonly" />
                                <label for="dependent_datepicker">Date of Birth*</label>
                                <span class="dependent_dob_errorClass"></span>
                            </div>
                            <div class="form-floating col-sm-4 mt-3">
                                <input type="text" name="dependent_place_birth" id="dependent_place_birth" class="form-control dependent_place_birth" placeholder="Place of Birth*" value="<?php echo e(old('dependent_place_birth')); ?>" autocomplete="off" />
                                <label for="dependent_place_birth">Place of Birth*</label>
                                <span class="dependent_place_birth_errorClass"></span>
                            </div>
                            <div class="form-floating col-sm-4 mt-3">
                                <select class="form-select form-control dependent_country_birth" id="dependent_country_birth" name="dependent_country_birth" placeholder="Country of Birth*" value="<?php echo e(old('dependent_country_birth')); ?>"  >
                        ...
                        <div class="form-group row mt-4">
                            <div class="form-floating col-sm-4 mt-3">
                                <select class="form-select form-control dependent_citizenship" name="dependent_citizenship" id="dependent_citizenship" placeholder="Citizenship*" value="<?php echo e(old('dependent_citizenship')); ?>"  >
        ...
        <div class="heading" data-bs-toggle="collapse" data-bs-target="#collapsespouseHome" aria-expanded="false" aria-controls="collapsespouseHome">
            <div class="row">
                <div class="col-2 my-auto">
                    <div class="image">
                        <img src="<?php echo e(asset('images/Icons_home_country_details.svg')); ?>" width="100%" height="100%">
                    </div>
                </div>
                <div class="col-1">
                    <div class="vl"></div>
            ...
            <div class="collapse" id="collapsespouseHome">
                <div class="form-sec">
                    <form method="POST" enctype="multipart/form-data" id="dependent_home_country_details">
                        ...
                        <div class="form-group row mt-4">
                            <div class="form-floating col-sm-12 mt-3">
                                <input type="text" name="passport_number" class="form-control passport_number" id="passport_number" placeholder="Passport Number*" value="<?php echo e(old('passport_number')); ?>" autocomplete="off"/>
                        ...
                        <div class="form-group row mt-4">
                            <div class="form-floating col-sm-6 mt-3">
                                <input type="text" name="dependent_passport_issue" class="form-control dependent_passport_issue" id="dependent_passport_issue" placeholder="Passport Date of Issue*" value="<?php echo e(old('dependent_passport_issue')); ?>" autocomplete="off" readonly="readonly"/>
                                <label for="dependent_passport_issue">Passport Date of Issue*</label>
                                <span class="dependent_passport_issue_errorClass"></span>
                            </div>
                            <div class="form-floating col-sm-6 mt-3">
                                <input type="text" name="dependent_passport_expiry" class="form-control dependent_passport_expiry"  id="dependent_passport_expiry" placeholder="Passport Date of Expiry*" value="<?php echo e(old('dependent_passport_expiry')); ?>" autocomplete="off" readonly="readonly" />
                        ...
                        <div class="form-group row mt-4">
                            <div class="form-floating col-sm-12 mt-3">
                                <input type="text" name="dependent_issued_by" class="form-control dependent_issued_by" id="dependent_issued_by" placeholder="Issued By(Authority that issued the passport)*" value="<?php echo e(old('dependent_issued_by')); ?>" autocomplete="off"/>
                        ...
                        <div class="form-group row mt-4">
                            <div class="form-floating col-sm-12 mt-3">
                                <input type="text" name="dependent_passport_copy" class="form-control dependent_passport_copy" id="dependent_passport_copy" placeholder="Upload Passport Copy*" value="<?php echo e(old('dependent_passport_copy')); ?>"  onclick="showDependentPassportFormat('dependent')" autocomplete="off" readonly/>

                                <div class="input-group-btn">
                                    <span class="fileUpload btn">
                                        <span class="upl" id="upload" onclick="showDependentPassportFormat()">Choose File</span>
                        ...
                        <div class="form-group row mt-4">
                            <div class="form-floating col-sm-3 mt-3">
                                <select class="form-select form-control dependent_home_country" name="dependent_home_country" placeholder="home_country*" id="home_country" value="<?php echo e(old('dependent_home_country')); ?>" autocomplete="off">
                            ...
                            <div class="form-floating col-sm-3 mt-3">
                                <input type="integer" name="dependent_postal_code" id="dependent_postal_code" value="<?php echo e(old('dependent_postal_code')); ?>" class="form-control dependent_postal_code" placeholder="Postal Code*" autocomplete="off">
    ...
    <div class="applicant-detail-sec">
        <div class="heading" data-bs-toggle="collapse" data-bs-target="#collapseSpouseCurrent" aria-expanded="false" aria-controls="collapseSpouseCurrent">
            <div class="row">
                <div class="col-2 my-auto">
                    <div class="image">
                        <img src="<?php echo e(asset('images/Icons_current_residency_and_work_details.svg')); ?>" width="100%" height="100%">
                    </div>
                </div>
                <div class="col-1">
                    <div class="vl"></div>
            ...
            <div class="collapse" id="collapseSpouseCurrent">
                <div class="form-sec">
                    <form method="POST" enctype="multipart/form-data" id="dependent_current_residency">
                        ...
                        <div class="form-group row mt-4">
                            <div class="form-floating col-sm-6 mt-3">
                                <select class="form-select form-control" id="dependent_current_country" name="dependent_current_country" placeholder="current_country*" value="<?php echo e(old('dependent_current_country')); ?>"  >
    ...
    <div class="applicant-detail-sec">
        <div class="heading" data-bs-toggle="collapse" data-bs-target="#collapseSpouseSchengen" aria-expanded="false" aria-controls="collapseSpouseSchengen">
            <div class="row">
                <div class="col-2 my-auto">
                    <div class="image">
                        <img src="<?php echo e(asset('images/Icons_schengen_details.svg')); ?>" width="100%" height="100%">
                    </div>
                </div>
                <div class="col-1">
                    <div class="vl"></div>
    ...
    <div class="applicant-detail-sec" style="margin-bottom: 70px">
        ...
        <div id="importExperienceDependent" data-clientId="<?php echo e($applicant['id']); ?>" data-dependentId="<?php echo e($dependent); ?>">
            <?php echo $__env->make('user.dependent-experience', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
</div><?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal - optimization\resources\views/user/main-applicant-dependent.blade.php ENDPATH**/ ?>