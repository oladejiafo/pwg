                            ...
                            <tbody><tr>
                                <td style="box-sizing:border-box;font-family:Yantramanav,sans-serif;max-width:100vw;padding:32px">
                                    <div style="box-sizing:border-box;font-family:Yantramanav,sans-serif;width:400px;height:250px;display:block;margin:30px auto">
                                        <img src="<?php echo e(asset('images/congratulationsicon.png')); ?>" alt="PWG Group" width="100%" height="100%">
                                    </div>
                                    <h1 style="box-sizing:border-box;font-family:Yantramanav,sans-serif;color:#3d4852;font-size:24px;font-weight:bold;margin-top:0;text-align:left">Dear <?php echo e($data['name']); ?>,</h1>
                                    <p style="box-sizing:border-box;font-family:Yantramanav,sans-serif;font-size:15px;line-height:1.5em;margin-top:0;text-align:left">Congratulations on becoming a partner with us! We're excited to have you on board and can't wait to see where this partnership takes us.</p>
                                    <p style="box-sizing:border-box;font-family:Yantramanav,sans-serif;font-size:15px;line-height:1.5em;margin-top:0;text-align:left">Thank you for choosing to work with us, and we're looking forward to achieving great things together. </p>                                    
...
<?php /**PATH C:\Users\Shamshera Hamza\pwg_client_portal - optimization\resources\views/emails/partner-congratulation.blade.php ENDPATH**/ ?>