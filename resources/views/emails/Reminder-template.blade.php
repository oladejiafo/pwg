                            ...
                            <tr>
                                <td style="box-sizing:border-box;font-family:Yantramanav,sans-serif;max-width:100vw;padding:0 32px 32px 32px">
                                    <div style="box-sizing:border-box;font-family:Yantramanav,sans-serif;width:400px;height:250px;display:block;margin:30px auto">
                                        <img src="{{asset('images/reminder.png')}}" alt="PWG Group" width="100%" height="100%">
                                    </div>
                                    ...
                                    <p style="box-sizing:border-box;font-family:Yantramanav,sans-serif;font-size:15px;line-height:1.5em;margin-top:0;text-align:left">Thank you for choosing and trusting us with your journey to {{ucFirst($data['product'])}}.</p>
                                                            ...
                                                            <table role="presentation" style="box-sizing:border-box;font-family:Yantramanav,sans-serif" cellspacing="0" cellpadding="0" border="0">
                                                                <tbody><tr>
                                                                    <td style="box-sizing:border-box;font-family:Yantramanav,sans-serif">
                                                                        <a href="{{env('APP_URL')}}/payment_form/{{$data['productId']}}" class="m_6264836849513322656button" rel="noopener" style="font-size: 20px;font-weight:500;box-sizing:border-box;float:left;border-radius:4px;color:#fff;display:inline-block;overflow:hidden;text-decoration:none;padding:12px;width:200px;text-align:center;background-color:#2ead0c!important;border:1px solid #c4c6cd" target="_blank" >Click to Pay Now</a>
                                                                    </td>
                                                                </tr>
                                                            </tbody></table>
                                                        </td>
