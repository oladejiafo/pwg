                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="box-sizing:border-box;font-family:Yantramanav,sans-serif;max-width:100vw;padding:0 32px 32px 32px">
                                    ...
                                    <h1 style="box-sizing:border-box;font-family:Yantramanav,sans-serif;color:#3d4852;font-size:24px;font-weight:bold;margin-top:0;text-align:left">New Payment Reminder</h1>
                                    <p style="box-sizing:border-box;font-family:Yantramanav,sans-serif;font-size:15px;line-height:1.5em;margin-top:0;text-align:left">Dear,</p>
                                    <p style="box-sizing:border-box;font-family:Yantramanav,sans-serif;font-size:15px;line-height:1.5em;margin-top:0;text-align:left">The applicant {{$data['client']}} had made the payemnt please verify.</p>
