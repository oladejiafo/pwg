                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                ...
                                <li><a class="dropdown-item" href="{{route('affiliate.toolbox')}}">ToolBox</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link btn create-new-button" aria-expanded="false" href="{{route('affiliate.total_earned',Session::get('loginId'))}}">
                                <span class="title" >BONUS</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link btn create-new-button" aria-expanded="false" href="{{route('affiliate.reffered_client',Session::get('loginId'))}}">
                                <span class="title" >REFERRALS</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link btn create-new-button" aria-expanded="false" href="{{url('/')}}">
