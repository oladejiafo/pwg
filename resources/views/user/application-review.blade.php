    ...
    <div class="col-12">
                            ...
                            <div class="heading"  data-bs-toggle="collapse" data-bs-target="#collapseReferrer" aria-expanded="true" aria-controls="collapseReferrer">
                                <div class="row">
                                    <div class="col-2 my-auto">
                                        <div class="image">
                                            <img src="{{asset('images/refferal.png')}}" width="85%" height="100%" alt="PWG Group" style="opacity: 0.82;">
                                        </div>
                                    </div>
                                    <div class="col-1">
                                        <div class="vl"></div>
                                    ...
                                    <div class="form-sec">
                                        <form method="POST" enctype="multipart/form-data" id="referrer_details">
                                            ...
                                            <div class="form-group row mt-4">
                                                ...
                                                <div class="form-floating col-sm-6 mt-3">
                                                    <input type="text" name="referrerPassport" id="floatingInput" class="form-control referrerPassport" placeholder="Referrer Passport Number" value="{{$applicant['referrer_passport_number_by_client']}}" autocomplete="off" />
        ...
        <div id="passportModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">            
                        <embed src="{{$client['passporUrl']}}" width="100%" height="400px" />
                    </div>
                    <div class="modal-footer">
        ...
        <div id="cvModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body">
                        <embed src="{{$client['resumeUrl']}}" width="100%" height="400px"/>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                    </div>
        ...
        <div id="residenceCopyModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <embed src="{{$client['residenceUrl']}}" width="100%" height="400px"/>    
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                    </div>
        ...
        <div id="visaCopyModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <embed src="{{$client['visaCopyUrl']}}" width="100%" height="400px"/>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                    </div>
        ...
        <div id="schengenVisatModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <embed src="{{$client['schengenVisaUrl']}}" width="100%" height="400px"/>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                    </div>
        ...
        @if($dependent)
            <div id="resumeModal" class="modal fade" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            <embed src="{{$dependent['resumeUrl']}}" width="100%" height="400px"/>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                        </div>
            ...
            <div id="dependentPassword" class="modal fade" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            <embed src="{{$dependent['passportUrl']}}" width="100%" height="400px"/>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                        </div>
            ...
            <div id="dependentResidence" class="modal fade" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            <embed src="{{$dependent['residenceUrl']}}" width="100%" height="400px"/>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                        </div>
            ...
            <div id="dependentVisa" class="modal fade" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            <embed src="{{$dependent['visaCopyUrl']}}" width="100%" height="400px"/>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                        </div>
            ...
            <div id="dependentSchengenVisatModal" class="modal fade" tabindex="-1">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            <embed src="{{$dependent['schengenVisaUrl']}}" width="100%" height="400px"/>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-primary close" data-dismiss="modal">Close</button>
                        </div>
