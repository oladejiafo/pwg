                                    ...
                                    <div class="collapse show" id="collapsechild{{$key+1}}">
                                        ...
                                        <div class="form-group row mt-4">
                                            <div class="col-lg-4 col-md-10 offset-lg-4 offset-md-1 col-sm-12">
                                                ...
                                                @else 
                                                    <button type="button" class="btn btn-primary submitBtn collapsechild{{$key+2}}" data-bs-toggle="collapse" data-bs-target="#collapsechild{{$key+2}}" aria-expanded="false" aria-controls="collapsechild{{$key+2}}">Continue</button>  
                                                @endif
                                            </div>
                                        </div>
                                    </div>
