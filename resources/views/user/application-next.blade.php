        ...
        <div class="col-12">
            <div class="row">
                ...
                <div class="tab-content clearfix">
                                            ...
                                            {{-- <form method="POST" enctype="multipart/form-data" id="applicant_details">
                                                ...
                                                <div class="form-group row mt-4">
                                                    <div class="col-sm-4 mt-3">
                                                        <input type="tel" name="first_name" class="form-control first_name" placeholder="First Name*" value="{{$name[0]}}" autocomplete="off"/>
                                    ...
                                    <div class="collapse" id="collapseCurrent">
                                        <div class="form-sec">
                                            {{-- <form method="POST" enctype="multipart/form-data" id="current_residency"> --}}
                                                ...
                                                <div class="form-group row mt-4">
                                                    <div class="col-lg-4 col-md-10 offset-lg-4 offset-md-1 col-sm-12">
                                                        <button type="button" class="btn btn-primary submitBtn collapseCurrent" data-bs-toggle="collapse" data-bs-target="#collapseSchengen" aria-expanded="false" aria-controls="collapseSchengen">Continue</button>
                                                    </div>
                                                </div>
                                            {{-- </form> --}}
                                        </div>   
                                    ...
                                    <div class="collapse" id="collapseSchengen">
                                        <div class="form-sec">
                                            {{-- <form method="POST" enctype="multipart/form-data" id="schengen_details">
                                                ...
                                                <div class="form-group row mt-4">
                                                    <div class="col-lg-4 col-md-10 offset-lg-4 offset-md-1 col-sm-12">
                                                        <button type="button" class="btn btn-primary submitBtn collapseSchengen" data-bs-toggle="collapse" data-bs-target="#collapseExperience" aria-expanded="false" aria-controls="collapseExperience">Continue</button>
                                                    </div>
                                                </div>
                                            {{-- </form> --}}
                                        </div>
                    ...
                    <div class="tab-pane active" id="dependant"></div>
...
<script>
    $(document).ready(function(){
        ...
        $('.applicantDetails').click(function(){
            ...
            if(($('#datepicker').val() != null) && ($('.first_name').val() != null) &&($('.surname').val() != null) && ($('.email').val() != null) && ($('.phone_number').val() != null) && ($('.country_birth').val() != null) && ($('.citizenship').val() != null) && ($('.sex').val() != null) && ($('#civil_status').val() != null)){
                $('.applicantData').show();
            }
        });
        $('.homeCountryDetails').click(function(){
            $('#collapseHome').removeClass('show');
        });
        $('.collapseCurrent').click(function(){
            $('#collapseCurrent').removeClass('show');
        });
        $('.collapseSchengen').click(function(){
