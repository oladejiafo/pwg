                ...
                <div class="applicant-detail-sec">
                    <div class="heading">
                        <div class="row">
                            <div class="col-2">
                                <div class="image">
                                    <img src="{{asset('images/Icons_current_residency_and_work_details.svg')}}" width="70%" height="auto">
                                </div>
                            </div>
                            <div class="col-1">
                                <div class="vl"></div>
                            ...
                            <div class="form-sec">
                                ...
                                @foreach ($jobCategories as $key => $jobCategoryOne)
                                    <div class="jobCategory">
                                        ...
                                        <div class="collapse" id="collapseExperience{{$key}}" style="width: 90%; margin-left:5%">
                                                ...
                                                <div class="jobCategoryTwo">
                                                    <div class="experience-sec">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-1 mx-auto my-auto">
                                                                <div class="down-arrow" data-bs-toggle="collapse" data-bs-target="#collapseExperienceTwo{{$keyTwo}}" aria-expanded="false" aria-controls="collapseExperienceTwo{{$keyTwo}}">
                                                                    <img src="{{asset('images/down_arrow.png')}}" height="auto" class="exp-image">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="collapse" id="collapseExperienceTwo{{$keyTwo}}" style="width: 90%; margin-left:5%">
                                                        @foreach($jobCategoryTwo['job_category_three'] as $keyThree => $jobCategoryThree)
                                                            <div class="jobCategoryThree">
                                                                <div class="experience-sec">
                                                                    <div class="row">
                                                                        <div class="col-11">
                                                                        ...
                                                                        <div class="col-1 mx-auto my-auto">
                                                                            <div class="down-arrow" data-bs-toggle="collapse" data-bs-target="#collapseExperienceThree{{$keyThree}}" aria-expanded="false" aria-controls="collapseExperienceThree{{$keyThree}}">
                                                                                <img src="{{asset('images/down_arrow.png')}}" height="auto" class="exp-image">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="collapse" id="collapseExperienceThree{{$keyTwo}}" style="width: 90%; margin-left:5%">
                                                                    @foreach($jobCategoryThree['job_category_four'] as $keyFour => $jobCategoryFour)
                                                                        <div class="experience-sec">
                                                                            <div class="row">
                                                                                ...
                                                                                <div class="col-1 mx-auto my-auto">
                                                                                    <div class="down-arrow" data-bs-toggle="collapse" data-bs-target="#collapseExperienceFour{{$keyFour}}" aria-expanded="false" aria-controls="collapseExperienceFour{{$keyFour}}">
                                                                                        <img src="{{asset('images/down_arrow.png')}}" height="auto" class="exp-image">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
