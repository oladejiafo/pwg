            ...
            <div class="row">
                <div class="col-2">
                    <div class="image my-auto">
                        <img src="{{asset('images/refferal.png')}}" width="100%" height="100%" alt="PWG Group" style="opacity: 0.82;">
                    </div>
                </div>
                <div class="col-1">
                    <div class="vl"></div>
                ...
                <div class="form-sec">
                    <form method="POST" enctype="multipart/form-data" id="referrer_details">
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="form-floating col-sm-6 mt-3">
                                <input type="text" name="referrerPassport" id="floatingInput" class="form-control referrerPassport" placeholder="Referrer Passport" value="{{$applicant['referrer_passport_number_by_client']}}" autocomplete="off" />
                        ...
                        <div class="row mt4">
                            <div class="col-lg-6 col-md-6 col-sm-12" style="margin-top: 30px">
                                <input type="checkbox" name="agree" autocomplete="off" id="refererCheckbox">
                                <span>If you don't have a referee, kindly agree.</span>
                            </div>
                        </div>
                        <div class="form-group row mt-4">
