        ...
        <div class="col-12">
            ...
            <div class="row">
                <div class="applicant-sec">
                    ...
                    <div class="form-sec">
                        <form method="POST" action="{{route('store.applicant.details')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row mt-4">
                                <div class="form-check col-lg-4 col-md-8 offset-lg-4 offset-md-4 col-sm-12 agree-terms">
                                    <input class=" checkcolor" type="checkbox" id="TnC" value="TnC" name="agree" value="{{old('agree')}}" required>
