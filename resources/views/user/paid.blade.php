...
@if ($paid->work_permit_status == 'WORK_PERMIT_RECEIVED' && $workpermitFile['FileExist'])
    ...
    @endif
@endif
@if ($paid->first_payment_remaining > 0 && strtoupper($paid->first_payment_status) == 'PARTIALLY_PAID' )
    @php
        $type = 'Pay';
        $color = '#800000';
                    ...
                    <div class="row paid-thumbnail">
                        <ul>
                                                ...
                                                <span
                                                    ...
                                                    <p>
                                                        ...
                                                        @elseif(isset($paym))
                                                            ...
                                                            @elseif($paid->first_payment_status == 'PARTIALLY_PAID' && $paid->first_payment_verified_by_cfo == 0 && $paid->is_first_payment_partially_paid == 1 && ($paid->first_payment_txn_mode == 'BALANCE_TRANSFER' || $paid->first_payment_txn_mode == 'TRANSFER'))
                                                                <button class="btn btn-secondary" style="font-size:16px;color:#7f8187" disabled>Being Verified..</button>
                            ...
                            @elseif(
                                ...
                                @elseif(
                                    $pays->third_payment_sub_total > 0 &&
                                        $pays->second_payment_sub_total > 0 &&
                                        ($pays->submission_payment_sub_total == 0 || empty($pays->submission_payment_sub_total)))
                                    <div class="row">
                                        <!-- 1st Payment Column  -->
                                        ...
                                        <div align="center" @if($pays->third_payment_sub_total > 0) class="col-lg-3 col-md-12 col-sm-12 img-fluid cellContainerx" @else class="col-lg-4 col-md-12 col-sm-12 img-fluid cellContainerx" @endif>
                                            <div class="upper">
                                                <span class="paid-item positionAnchor" href="#">
                                                    ...
                                                    <span
                                                        ...
                                                        <p>
                                                            ...
                                                            @elseif(isset($paym))
                                                                @if(in_array($paid->second_payment_status,['PENDING', 'PARTIALLY_PAID']) && $paid->second_payment_verified_by_cfo == 0 && $paid->is_second_payment_partially_paid == 0 && $paid->second_payment_txn_mode == 'TRANSFER')
                                                                    <button class="btn btn-secondary" style="font-size:16px;color:#7f8187" disabled>Being Verified..</button>
                                                                @elseif($paid->secondn_payment_status == 'PARTIALLY_PAID' &&  $paid->second_payment_verified_by_cfo == 0 && $paid->is_second_payment_partially_paid == 1 && ($paid->second_payment_txn_mode == 'BALANCE_TRANSFER' || $paid->second_payment_txn_mode == 'TRANSFER'))
                                                                    <button class="btn btn-secondary" style="font-size:16px;color:#7f8187" disabled>Being Verified..</button>
                                                                @else
                                                                    @if ($paid->application_stage_status != 5)
                                                                        <button class="btn btn-secondary toastrDefaultError"
                                        ...
                                        @if($pays->third_payment_sub_total > 0)
                                            <!-- 3rd Payment Column  -->
                                    ...
                                    @elseif(
                                        ...
                                        <div class="row">
                                            <!-- 1st Payment Column  -->
                                            <div align="center" class="col-lg-4 col-md-12 col-sm-12 img-fluid cellContainerx">
                                                <div class="upper">
                                                    <span class="paid-item " href="#">
                                                        <span
                                                            {{-- class="positionAnchor  @if ($paid->first_payment_status == 'PAID' && $paid->first_payment_price == $paid->first_payment_paid)  watermarked @endif paid-thumbnail"> --}}
