    ...
    <div class="card-body paid-section" style="background-color:#444C64;">
        ...
        <div class="carousel" id="carouselThree" data-ride="carousel">
            <div class="outer scroll-pane" id="container">
                        ...
                        <ul>
                                      ...
                                      <span class="paid-item positionAnchor" href="#">
                                                ...
                                                <div class="dg aligns-items-center justify-content-center text-center"
                                                    ...
                                                    @if ($paid->application_stage_status != 5)
                                                        ...
                                                        @else
                                                            ...
                                                            @endphp
                                                        @endif
                                                        <a href="{{ route($linkk, $paid->destination_id) }}" class="domore">
                                                            <p
                                        ...
                                        {{-- <div class="cardc downlaod-item  d-flexx aligns-items-center justify-content-center text-center" style="font-weight: bold;font-family:'TT Norms Pro'; display:inline-block"> --}}
                                          ...
                                          @endif
                                            <div class="dg aligns-items-center justify-content-center text-center" style="display:inline; justify-content: center;  align-items: center;">
                                              ...
                                              <span  class="prodd" style="font-size:11px; color:grey;padding-left:1px; padding-right:1px">{{$workpermit['message']}}</span> 
                                        ...
                                        <div class="cardc downlaod-item  d-flexx aligns-items-center justify-content-center text-center" style="font-weight: bold;font-family:'TT Norms Pro'; display:inline-block"> --}}
                                          ...
                                          <div style="display:inline" id="de" class="block2 download-thumbnail img-fluid">
                                            ...
                                            <span class="prodd" style="font-size:11px; color:grey;padding-left:1px; padding-right:1px;">Embassy appearance pending.</span>
                                            </div>
                                        ...
                                        <div class="cardc downlaod-item  d-flexx aligns-items-center justify-content-center text-center" style="font-weight: bold;font-family:'TT Norms Pro'; display:inline-block;"> --}}
                                          <div class="cardc-body">
                                            ...
                                            <p style="padding-top: 27px;padding-bottom:0px; font-size:14px;font-weight:800">Download Contract</p>
                                            <span class="prodd" style="font-size:11px; color:grey;padding-left:1px; padding-right:1px;line-height:1px;">
                                              @if(strlen($paid->contract)>2)
                            ...
                            @elseif(
                              ...
                              <li>
                                <div align="center" class="col-md-4 col-sm-12 img-fluid cellContainer">
                                  <span class="paid-item " href="#">
                                    <span class="positionAnchor  @if($paid->submission_payment_status =='PAID')) watermarked @endif paid-thumbnail">
                                      <img src="../user/images/submission_payment.svg" height="500px" class="img-fluid" alt="PWG Group">
                                      <span class="title" style="align: center;">
                                        <h3 class="paid-title" style="font-size: 21px; color:aliceblue"></h3>
                            ...
                            @elseif(
                                ...
                                <!-- 1st Payment Column  -->
                                <li>
                                  <div align="center" class="col-md-3 col-sm-12 img-fluid cellContainer">
                                      <span class="paid-item " href="#">
                                          <span
                                              class="positionAnchor  @if ($paid->first_payment_status == 'PAID') ) watermarked @endif paid-thumbnail">
                                              <img src="../user/images/first_payment.svg" height="500px"
                                        ...
                                        <span class="paid-item " href="#">
                                            <span
                                                ...
                                                <img src="../user/images/submission_payment.svg" height="500px"
                                                    class="img-fluid" alt="PWG Group">
                                                <span class="title" style="align: center;">
                                                    <h3 class="paid-title" style="font-size: 21px; color:aliceblue">
                                                    </h3>
                                        ...
                                        <div class="cardc-body">
                                            ...
                                            <div style="display:inline" id="dd"
                                                ...
                                                <svg style="margin:auto;margin-top:20px" width="39"
                                                    height="30" class="dd" viewBox="0 0 39 30" fill="none"
                                    ...
                                    <div class="cardc downlaod-item  d-flexx aligns-items-center justify-content-center text-center"
                                        ...
                                        <div class="cardc-body">
                                            ...
                                            <div style="display:inline" id="de"
                                                ...
                                                <svg style="margin:auto;margin-top:7px" width="38" height="45"
                                                    class="de" id="Layer_1" data-name="Layer 1"
                                    ...
                                    <div align="center" class="col-md-3 col-sm-12 img-fluid cellContainer">
                                        <span class="paid-item " href="#">
                                            <span
                                                ...
                                                <p
                                                    style="font-size: 10px;position:absolute;margin:0 15%;margin-top:-65%;z-index:99;color:#7f8187">
                                                    <i>To be deducted from salary at destination</i></p>
                                            </span>
                                        </span>
                ...
                <div class="controls">
                <a class="carousel-control-prev" id="slideBack" href="#carouselThree" style="text-decoration:none;"
                    role="button" data-slide="prev">
                    <i class="lni lni-arrow-left"></i>
                </a>
                <a class="carousel-control-next" id="slide" href="#carouselThree" style="text-decoration:none;"
...
@if (strtoupper($paid->second_payment_status) != 'PAID' &&
    ...
    @if (isset($prod->id))
        ...
        <div class="card d-flex aligns-items-center justify-content-center text-center wiggy"
            ...
            <h3 style="font-size:36px">Earn {{ round($prod->full_payment_discount ?? 5) }}% discount when you pay
                full amount! </h3>
