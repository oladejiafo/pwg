...
@section('content')
    <div class="container">
        ...
        <div class="form-sec" style="margin-top: 48px;">
            <form method="POST" action="{{route('add-referer')}}">
                @csrf
                ...
                <div class="mb-3">
                    <div class="inputs">
                        <input type="password" class="form-control w-full ref" name="referrer_last_name" placeholder="Referrer Last Name" autocomplete="off" autofocus style="border: none">
                ...
                <div class="mb-3">
                    <div class="inputs"> 
                        <select class="form-control w-full ref current_location" name="current_location">
