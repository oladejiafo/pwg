                    ...
                    <!-- col-lg-6 col-md-6 col-12 offset-md-3 offset-lg-3 -->
                        ...
                        @endif
                            ...
                            <?php
                                ...
                                $outsec = $pays->second_payment_remaining;
                                $outsub= $pays->submission_payment_remaining;
                                 ...
                                 $discount=0;
                                    ...
                                    $discountPercent = 0;
                                        if($pays->first_payment_status =="PENDING" && $pays->submission_payment_status =="PENDING" & $pays->second_payment_status =="PENDING") {
                                            ...
                                            // $discountPercent = '5%';
                                            // $discount = ($payNow * 5 / 100);
                                        } elseif ($pays->first_payment_status =="PAID" && $pays->submission_payment_status =="PAID" && ($pays->second_payment_status =="PENDING" || $pays->second_payment_status == 'PARTIALLY_PAID' )) {
                                            $payNow = $pdet->second_payment_sub_total;
                                            $payNoww = $payNow;
                                            $pendMsg = "";
                                            $discountPercent = '';
                            ...
                            ?>
                                ...
                                <div class="row payament-sec">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        @if($whichPayment =="FIRST" && $pays->first_payment_paid == 0)
                                    ...
                                    <div class="partial-total-sec">
                                        ...
                                        @if($pays->first_payment_paid > 0 && $pays->first_payment_remaining > 0 && $payall ==0 ) 
                                        ...
                                        @elseif($pays->submission_payment_paid > 0 && $pays->submission_payment_remaining > 0 && $payall ==0 && (strtolower($whichPayment) == "submission" || strtolower($whichPayment) == "balance_on_submission"))
                                            ...
                                            <input type="hidden" id="totaldue" name="totaldue" value="{{ round(($payNow + $vat),2) }}">
                                            <input type="hidden" name="totalremaining" value="{{round($pends,2)}}">
                                        @elseif($pays->second_payment_paid > 0 && $pays->second_payment_remaining > 0 && $payall ==0 && (strtolower($whichPayment) == "second" || strtolower($whichPayment) == "balance_on_second"))
                                        ...
                                        @else
                                            <h2 style="font-size: 1em;">Now you will pay {{strtolower($whichPayment)}} installment only
                                                <span id="amountLink">
                                                    ...
                                                    <b><span id="amountLink"> {{(($pays->first_payment_status !="PAID") ? (($diff > 0) ? number_format((floor(((($payNoww - $discount)+ $vat))*100)/100),2) : (number_format((floor((($payNoww - $discount)+ $vat)*100)/100),2))):number_format((floor((($payNoww - $discount)+ $vat)*100)/100),2))}} </span></b>
                                                </span> AED 
                                                <span style="font-size:11px;opacity:0.6"  id="amountText">
                                                    @if($vat>0) 
                                            ...
                                            <input type="hidden" id="amountLink2" name="totalpay" value="{{(($pays->first_payment_status !="PAID") ? (($diff > 0) ? (round(((($payNoww - $discount)+ $vat)),2)) : round((($payNoww - $discount)+ $vat),2)):round((($payNoww - $discount)+ $vat),2))}}">
