    ...
    #card-payment input[type='checkbox']:checked:after {
        ...
        background-color: #FACB08;
                    ...
                    <div classx="form-sec discountForm">
                            <div align="left" style="background-color: #Fff;padding: 30px 0px">
                                ...
                                <div align="left" class="row payoption" style="--bs-gutter-x:0px;display:fles; width:100%; margin:0 auto; margin-bottomx: -30px;margin-topx:10px">
                                    <div class="col-4" style="margin-left:-10px;display:inline-block;" align: left> 
                                        ...
                                        <label for="card"><img src="{{asset('user/images/card_pay.png')}}" height="30px"> <span class="brk"><span id="optCA">Card Payment</span><span id="optCB">Card Payment</span></span></label>
                                    </div>
                            ...
                            <div class="row">
                                @if((!isset($pays)) || ((isset($pays)) && ($pays->first_payment_status == "PENDING")))
                                    <div class="col-md-6">
                            ...
                            <div class="partner-sec  col-md-5 col-lg-5 col-sm-12" >
                                ...
                                <p class="status">
                                    Yes
                                    <label class="switch">
                                        <input type="radio" id="yesmySpouse" name="spouse" @if($XYZ == 'yes' ) checked="checked" @endif   value="yes">
                                        <span class="slider round"></span>
                                    </label>
                                    
                                    No
                                    <label class="switch">
                                        <input type="radio" id="mySpouse" name="spouse" @if($XYZ == 'no' || $XYZ == null) checked="checked" @endif  value="no">
                                        <span class="slider round"></span>
                                    </label>
                                </p>
                            </div>
                            ...
                            <div class="children-sec col-md-6 col-lg-6 col-sm-12">
                                    ...
                                    <div class=" row children" style="widthx:35%">
                                        <div class="col-2">
                                            <input type="radio" id="none" name="children" class="kids" @if($ABC == 0 || $ABC==null ) checked="checked" @endif   value="0"/>
                                            <label for="none">None</label>
                                        </div>
                                        <div class="col-2">
                                            <input type="radio" id="one" name="children" class="kids" @if($ABC == 1 || $ABC==null ) checked="checked" @endif  value="1"/>
                                            <label for="one">One</label>
                                        </div>
                                        <div class="col-2">
                                            <input type="radio" id="two" name="children" class="kids" @if($ABC == 2 ) checked="checked" @endif  value="2" />
                                            <label for="two">Two</label>
                                        </div>
                                        <div class="col-2">
                                            <input type="radio" id="three" name="children" class="kids" @if($ABC == 3 ) checked="checked" @endif  value="3" />
                                            <label for="three">Three</label>
                                        </div>
                                        <div class="col-2">
                                            <input type="radio" id="four" name="children" @if($ABC == 4 ) checked="checked" @endif  value="4" />
                ...
                <div class="modal-dialog modal-lg row" style="height:80%">
                    <div class="modal-content col-4" style="border-radius: 15px">
                        ...
                        <div class="modal-body contractFileUrl" style="height:100%">
                            @if(Session::has('contractFileUrl'))
                                <embed src="{{Session::get('contractFileUrl')}}#toolbar=0&navpanes=0&pagemode=none" width="100%" height="100%" view="fit" type="application/pdf" />
                            @else 
