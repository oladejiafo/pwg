                    ...
                    <form method="POST" enctype="multipart/form-data" id="dependent_home_country_details">
                        ...
                        <div class="form-group row mt-4">
                            ...
                            {{-- <div class="col-sm-6 mt-3">
                                <input type="tel" onkeypress="return isNumberKey(event)" name="dependent_home_phone_number" id="dependent_home_phone_number" class="form-control dependent_home_phone_number" placeholder="Phone Number" value="{{old('dependent_home_phone_number')}}" autocomplete="off" />
                            </div> --}}
                        </div>
                        <div class="form-group row mt-4">
                    ...
                    <form method="POST" enctype="multipart/form-data" id="dependent_current_residency">
                        ...
                        <div class="form-group row mt-4">
                            ...
                            <div class="form-floating col-sm-6 mt-3">
                                ...
                                <input type="tel" onkeypress="return isNumberKey(event)" class="form-control" id="dependent_current_residance_mobile" name='dependent_current_residance_mobile' value="{{old('dependent_current_residance_mobile')}}" placeholder="Current Residence Mobile Number" autocomplete="off">
