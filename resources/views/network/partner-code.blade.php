                    ...
                    <form method="POST" action="{{route('add.network.partner')}}">
                        ...
                        <div class="form-group row mb-3">
                            <div class="form-floating col-sm-12">
                                <input type="text" readonly name="global_mobility_consultant_code" class="form-control global_mobility_consultant_code" id="floatingInput" placeholder="Global Mobility Consultant Code" value="{{$code}}" autocomplete="off"/>
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="form-floating col-sm-6 mt-4">
                                    <select class="form-select form-control payment_type" name="payment_type" id="payment_type" placeholder="Payment Type*">
                                        ...
                                        <option @if(old('payment_type') == 'Bank Payment') selected @endif value="Bank Payment">Bank Payment</option>
                                    </select>
                            ...
                            <div class="form-group row mt-4">
                                <div class="form-floating">
                                    <select class="form-select form-control partner_city" name="partner_city" id="partner_city" placeholder="Payment Type*" value="{{old('partner_city')}}">
                                        ...
                                        <option @if(old('partner_city') == 'Dubai') selected @endif value="Dubai">Dubai</option>
                                        <option @if(old('partner_city') == 'Abudhabi') selected @endif value="Abudhabi">Abudhabi</option>
                                    </select>
